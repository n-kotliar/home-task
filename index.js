import{d as B,h as C}from"./assets/exercises_card-K8mKdohk.js";const n={filters:document.querySelector(".filters"),navButtons:document.querySelector(".nav-buttons"),musclesBtn:document.querySelector(".muscles-btn"),exercisesTitle:document.querySelector(".exercises-title"),searchForm:document.querySelector(".search-form"),loadMoreBtn:document.querySelector(".load-more-btn"),quoteContainer:document.querySelector(".quote"),pagination:document.querySelector(".pagination"),exercises:document.querySelector(".exercises-div")};let F=window.innerWidth<768?9:12,H=window.innerWidth<768?8:10,a=1,u="Muscles",w="Muscles",S="",y="",h="",m=[];B(n.quoteContainer);g();n.musclesBtn.classList.add("active-btn");n.filters.addEventListener("click",I);n.exercises.addEventListener("click",A);n.searchForm.addEventListener("input",O);var L;(L=n.loadMoreBtn)==null||L.addEventListener("click",loadMore);async function g(e=!0){e&&(a=1,n.exercises.innerHTML="");let t=`https://your-energy.b.goit.study/api/filters?filter=${u}&page=${a}&limit=${F}`;w.trim()&&(t+=`&name=${w}`);const r=await(await fetch(t)).json();if(!r.results.length){$();return}j(r.results),E(r.totalPages)}function j(e){const t=`
    <ul class="exercises">
