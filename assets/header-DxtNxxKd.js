...
`,Q=async e=>{const{quote:t,author:s}=await R();e.innerHTML=J(t,s)},v={root:document.querySelector(".scrollbar_custom"),quoteContainer:document.querySelector(".quote")};let a=1;const L=8,D=(e,t)=>{const s=(t-1)*L;return e.slice(s,s+L)},j=(e=[])=>{const t=new Set;return e.filter(s=>!(s!=null&&s._id)||t.has(s._id)?!1:(t.add(s._id),!0))};function W(){v.root.innerHTML=`
  ...
  `;let n=Math.max(1,a-1),r=Math.min(e,a+1);a===1&&(r=Math.min(e,3)),a===e&&(n=Math.max(1,e-2)),n>1&&(t+=s(1),n>2&&(t+='<li class="dots">...</li>'));for(let o=n;o<=r;o++)t+=s(o);return r<e&&(r<e-1&&(t+='<li class="dots">...</li>'),t+=s(e)),t+="</ul>",t}function p(){if(!v.root)return;const e=j(w(b)||[]);if(!e.length){W();return}const t=Math.ceil(e.length/L);a>t&&(a=t);const s=window.innerWidth<1440?D(e,a):e;v.root.innerHTML=U(s)+(window.innerWidth<1440?Y(t):"")}var $;($=v.root)==null||$.addEventListener("click",e=>{const t=e.target.closest('[data-action="delete"]'),s=e.target.closest('[data-action="start"]'),n=e.target.closest(".pagination-btn");if(t&&(_(t.dataset.id),p()),s){const o=(w(b)||[]).find(i=>i._id===s.dataset.id);o&&se(o,!0,!0)}if(n){const r=Number(n.dataset.page);r!==a&&(a=r,p())}});window.addEventListener("resize",()=>{a=1,p()});p();Q(v.quoteContainer);async function G(e,{email:t,rate:s,comment:n}){const r=`https://your-energy.b.goit.study/api/exercises/${e}/rating`;s=Number(s);const o=await fetch(r,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:t,rate:s,review:n})});if(!o.ok){const i=await o.json();throw new Error(i.message||"Rating failed")}return o.json()}const K=document.getElementById("form-close-btn"),y=document.querySelector(".backdrop"),z=document.querySelector(".backdrop-form"),N=document.querySelector("#user-email"),F=document.getElementById("user-comment"),V=document.querySelector(".form-send-btn"),X=document.querySelector(".rating-wrapper"),O=document.querySelector(".rating-star-value");let B=null;const c={rate:0,email:"",comment:""};V.disabled=!1;function Z(){N.value="",F.value="",c.rate=0,c.comment="",c.email="",O.textContent="0.0",document.querySelectorAll(".rating-star-icons").forEach(e=>{e.style.fill="var(--white-20)"})}function x(){y.classList.remove("is-open"),document.removeEventListener("keydown",C),typeof window.reopenExerciseModal=="function"&&window.reopenExerciseModal()}function C(e){e.key==="Escape"&&x()}K.addEventListener("click",x);y.addEventListener("click",e=>{e.target===y&&x()});X.addEventListener("click",e=>{if(!e.target.dataset.id)return;const t=document.querySelectorAll(".rating-star-icons");c.rate=Number(e.target.dataset.id),t.forEach((s,n)=>{s.style.fill=n<c.rate?"var(--star-color)":"var(--white-20)"}),O.textContent=`${c.rate}.0`});function ee(e){B=e,y.classList.add("is-open"),document.addEventListener("keydown",C)}z.addEventListener("submit",te);async function te(e){if(e.preventDefault(),c.email=N.value.trim(),c.comment=F.value.trim()||void 0,!c.rate){g.Notify.failure("Please select a rating");return}if(!c.email){g.Notify.failure("Please enter your email");return}try{await G(B,c),g.Notify.success("Your rating has been saved!"),Z(),x()}catch(t){g.Notify.failure(t.message||"Something went wrong")}}const l=document.querySelector(".exr-card-backdrop");let d=!1,u=[],q=JSON.parse(localStorage.getItem("favourite"));q&&q.forEach(e=>{u[0]||(u[0]=e),u.push(e)});function h(e){return`${e.charAt(0).toUpperCase()}${e.slice(1)}`}function f(e){e.key==="Escape"&&(l.classList.remove("card-is-open"),document.body.classList.remove("not-scrollable"),document.removeEventListener("keydown",f))}function se(e,t=!1,s=!1){d=t,d||u.forEach(n=>{n._id===e._id&&(d=!0)}),oe(e),l.classList.add("card-is-open"),document.body.classList.add("not-scrollable"),document.addEventListener("keydown",f),d===!0&&(document.querySelector(".add-favourite-btn").innerHTML=`Remove from
    ...
    <div class="exr-card-cont">
      ...
      <div class="buttons-cont">
        ...
        <button name="rating" class="give-rating-btn">Give a rating</button>
          ...
          <svg class="heart-icon" width="20px" height="20px">
            <use href="/home-task/icons.svg#icon-heart"></use>
          </svg>`,d=!0),p()}),document.getElementById("close-card").addEventListener("click",()=>{l.classList.remove("card-is-open"),document.body.classList.remove("not-scrollable"),document.removeEventListener("keydown",f)}),l.addEventListener("click",i=>{i.target===l&&(l.classList.remove("card-is-open"),document.body.classList.remove("not-scrollable"),document.removeEventListener("keydown",f))}),document.querySelector(".give-rating-btn").addEventListener("click",()=>{l.classList.remove("card-is-open"),document.body.classList.remove("not-scrollable"),document.removeEventListener("keydown",f),ee(e._id)})}const re=document.querySelector(".open-mobile-menu-btn"),ne=document.querySelector(".close-mobile-menu-btn"),k=document.querySelector(".mobile-menu-wrapper"),ie=document.querySelector(".mobile-menu"),ae=document.querySelector(".header-nav-link-fav"),ce=document.querySelector(".header-nav-link-home"),I=window.PAGE;I==="fav"&&ae.classList.add("active");I==="home"&&ce.classList.add("active");re.addEventListener("click",()=>{k.classList.add("is-open"),document.body.classList.add("not-scrollable")});ne.addEventListener("click",()=>{T()});k.addEventListener("click",()=>{T()});ie.addEventListener("click",e=>{e.stopPropagation()});function T(){k.classList.remove("is-open"),document.body.classList.remove("not-scrollable")}export{Q as d,se as h};
//# sourceMappingURL=header-DxtNxxKd.js.map
